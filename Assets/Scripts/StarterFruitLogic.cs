...
public class StarterFruitLogic : MonoBehaviour
{
    ...
    private GameObject waterMelonMesh;
    ...
    void Start()
    {
        ...
        waterMelonMesh = transform.GetChild(0).gameObject;
    ...
    void Update()
    {
        ...
        transform.eulerAngles = new Vector3(45f, previousYRotation -30 * Time.deltaTime, 0f);
        Vector3 rotationAmount = new Vector3(0, -30 * Time.deltaTime, 0);
        waterMelonMesh.transform.rotation *= Quaternion.Euler(rotationAmount);
    }
    ...
    private void OnTriggerStay(Collider other)
    {
            ...
            other.gameObject.GetComponent<BladeLogic>().velocity.magnitude > 0.00003f)
        {
            ...
            gameManager.GetComponent<GameManager>().SetupNewGame();
        }
    }
